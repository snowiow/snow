...
#+END_SRC
* Keyboard Layout
This variable controls my current keyboard layout
#+begin_src emacs-lisp
    (defvar snow/current-keyboard-layout 'colemak
      "Current keyboard layout: 'colemak or 'qwerty")
#+end_src

With this function I can toggle between both layouts, depending if I'm at the Laptop (QWERTY) or if I have my Ferris Sweep available.
#+begin_src emacs-lisp
